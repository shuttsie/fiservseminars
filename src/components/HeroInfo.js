...
const HeroInfo = () => (
   <div className="hero-container">
      ...
      <h3>Register for the Precision Education Seminar</h3>
         ...
         <p>
            This fall, the Precision Education Seminars are three days of interactive sessions that provide the ideal setting to gain new perspectives and make valuable connections with peers and Fiserv experts. During the three days you will experience a Simulive training event, OnDemand recordings including a look into the new UI and NextGen, a virtual social hour, a chance to win awesome prizes, a few special video surprises and access to the electronic version of the meeting material.
         </p>
      <h2>Fees</h2>
