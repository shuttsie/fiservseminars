...
const HeroInfo = () => (
   <div className="hero-container">
      ...
      <h3>Register for the Premier Education Seminar</h3>
         ...
         <p>
            This fall, the Premier Education Seminars are three days of interactive sessions that provide the ideal setting to gain new perspectives and make valuable connections with peers and Fiserv experts.
         </p>
      <h2>Fees</h2>
