...
const HeroInfo = () => (
   <div className="hero-container">
      ...
      <h3>Register for the Premier Education Seminar</h3>
         <p>
         ...
         <p>
            This fall, the Premier Education Seminars are three days of interactive sessions that provide the ideal setting to gain new perspectives and make valuable connections with peers and Fiserv experts. During the three days you will experience a Simulive training event, OnDemand recordings including a look into the new User Interface (UI) and Abiliti for online banking, a virtual social hour, a chance to win awesome prizes, a few special video surprises and access to the electronic version of the meeting material.
         </p>
      <h2>Fees</h2>
         ...
         <ul>
            <li>Early registration fee through August 31: 
               <ul>
                  ...
                  <li>$850 for <b>2</b> connections - *SimuLive and OnDemand Recordings available through January 31, 2021</li> 
               </ul>
            </li>
            <br />
            <li>Standard registration fee after August 31:
               <ul>
                  ...
                  <li>$950 for <b>2</b> connections - *SimuLive and OnDemand Recordings available through January 31, 2021</li>
                  <li>$1,750 for <b>3 or more</b> connections - *SimuLive and OnDemand Recordings available through January 31, 2021</li>
               </ul>
            </li>
         </ul>
      </div>
